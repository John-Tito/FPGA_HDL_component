...
if { [get_ips uart_pkt_info_fifo] == "" } {
  create_ip -name axis_data_fifo -vendor xilinx.com -library ip -version 2.0 -module_name uart_pkt_info_fifo
  ...
  ] [get_ips uart_pkt_info_fifo]
}

if { [get_ips uart_axis_fifo] == "" } {
  create_ip -name axis_data_fifo -vendor xilinx.com -library ip -version 2.0 -module_name uart_axis_fifo
  set_property -dict [list\
    CONFIG.TID_WIDTH {5}\
